...
COMMENT ON COLUMN "UPLOAD_FILE".FILE_RENAME IS '변경된파일명';
COMMENT ON COLUMN "UPLOAD_FILE".FILE_UPLOAD_DATE IS '업로드날짜';
COMMENT ON COLUMN "UPLOAD_FILE".UPLOAD_FILE IS '멤버테이블의 PK참조';
...
INSERT INTO "BOARD_TYPE" VALUES(SEQ_BOARD_CODE.NEXTVAL, '정보게시판');
...
------------------------------------------------------------------------------------
--CEIL(DBMS_RANDOM.VALUE(0,3)) : 1,2,3중하나
...
SEQ_IMG_NO.NEXTVAL, '/images/board/','원본1.jpg','시나모롤.jpg',0,1999
);

INSERT INTO "BOARD_IMG" VALUES(
SEQ_IMG_NO.NEXTVAL, '/images/board/','원본2.jpg','리락쿠마.jpg',1,1999
);

INSERT INTO "BOARD_IMG" VALUES(
SEQ_IMG_NO.NEXTVAL, '/images/board/','원본3.jpg','시나모로올.jpg',2,1999
);


INSERT INTO "BOARD_IMG" VALUES(
SEQ_IMG_NO.NEXTVAL, '/images/board/','원본4.jpg','쿠마.jpg',3,1999
);

INSERT INTO "BOARD_IMG" VALUES(
SEQ_IMG_NO.NEXTVAL, '/images/board/','원본5.jpg','쿠우마아.jpg',4,1999
);
